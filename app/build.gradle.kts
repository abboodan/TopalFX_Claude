...
android {
    namespace = "com.topaloglu.topalfx"
    compileSdk {
        version = release(36) {
            minorApiLevel = 1
        }
    ...
    defaultConfig {
        applicationId = "com.topaloglu.topalfx"
        minSdk = 29
        targetSdk = 36
        versionCode = 7
        versionName = "1.3.3"
    ...
    signingConfigs {
        create("release") {
            val ksPath = providers.environmentVariable("RELEASE_KEYSTORE_PATH").orNull
            if (ksPath != null) {
    ...
    buildTypes {
        release {
            ...
            signingConfig =
                if (providers.environmentVariable("RELEASE_KEYSTORE_PATH").orNull != null)
